...
<script>
import Hot from "@/components/Screen/Hot.vue";
import Map from "@/components/Screen/Map.vue";
import Rank from "@/components/Screen/Rank.vue";
import Seller from "@/components/Screen/Seller.vue";
import Stock from "@/components/Screen/Stock.vue";
import Trend from "@/components/Screen/Trend.vue";
import { mapState } from "vuex";
import { getThemeValue } from "@/utils/screen/theme_utils";
import StatusPie from '@/components/Screen/StatusPie'
import PersonsBar from '@/components/Screen/PersonsBar'
import OrderAmountBar from '@/components/Screen/OrderAmountBar'
import Logo from '@/components/Screen/Logo'
export default {
  name: 'screen',
  components: {
    OrderAmountBar,
  ...
  methods: {
    ...
    handleChangeTheme() {
      // 修改VueX中数据
      this.$store.commit("screen/changeTheme");
    },
  },
  computed: {
    logoSrc() {
      return require("@/assets/screen/img/" + getThemeValue(this.theme).logoSrc);
    },
    headerSrc() {
      return require("@/assets/screen/img/" + getThemeValue(this.theme).headerBorderSrc);
    },
    themeSrc() {
      return require("@/assets/screen/img/" + getThemeValue(this.theme).themeSrc);
    },
    containerStyle() {
      return {
